...
Created an interface that makes it easy for non-developers to view and interact with information stored in databases. Often these interfaces are known as **C**ontent **M**anagement **S**ystems (CMS for short). In this assignment, using node, inquirer, and MySQL, I built a solution for managing a company's employees.
